...
@interface HumidityViewController () <ChartViewDelegate>
...
- (void)viewDidLoad {
    ...
    [_sensorDetails registerNib:nib forCellReuseIdentifier:@"SmartDeviceTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(pr.type == OCREP_PROP_DOUBLE) {
        ...
        if([pr.resourceName containsString:@"humid"]) {
            [_chartValues addObject:[[ChartDataEntry alloc] initWithX:k++ y:pr.resourceDoubleValue icon: [UIImage imageNamed:@"icon"]]];
        }
