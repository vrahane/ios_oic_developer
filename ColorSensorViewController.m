...
#import "ColorSensorViewController.h"
#import <Charts/Charts-Swift.h>
#import "SmartDeviceTableViewCell.h"

@interface ColorSensorViewController () <ChartViewDelegate>
@property (strong, nonatomic) NSMutableArray *chartValues;
@end

@implementation ColorSensorViewController
